...
const Signup = ({API_URL = import.meta.env.VITE_BASE_URL, onSignup}) => {
...
// fetch profile
    ...
    // to validate if each field is filled by user or not
    const validateForm = () => {
    const newErrors = {};
            ...
            <div className={signupStyles.formContainer}>
                ...
                <form onSubmit={handleSubmit} noValidate>
                    <div className='mb-6'>
                        ...
                        {errors.name && (
                            <p className={signupStyles.error}>{errors.name}</p>
                        )}
                    </div>
