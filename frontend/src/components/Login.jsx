...
const Login = ({onLogin, API_URL = import.meta.env.VITE_BASE_URL}) => {
        ...
        try {
            ...
            if(typeof onLogin === "function"){
                try {
                    ...
                    console.warn("onLogin threw: ", error);
                    navigate("/");
                }
            } else{
                navigate("/");
    ...
    <div className={loginStyles.pageContainer}>
        <div className={loginStyles.cardContainer}>
            <div className={loginStyles.header}>
                ...
                <p className={loginStyles.headerSubtitle}>Sign into your Expense Tracker account</p>
            </div>
                ...
                <form onSubmit={handleSubmit}>
                    <div className="mb-6">
                        ...
                        <div className={loginStyles.inputContainer}>
                            ...
                            className={loginStyles.input} placeholder='yo@rmail.com' required/>
                        </div>
                    </div>
                    <div className="mb-6">
