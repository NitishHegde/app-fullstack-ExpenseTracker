...
import { Home, ArrowUp, ArrowDown, User, HelpCircle, LogInIcon, X, Menu, LogOutIcon } from 'lucide-react';
...
const {name: username = "User", email = "user@email.com"} = user || {};
const initial = username.charAt(0).toUpperCase();

// check for oveflow in mobile
  useEffect(() => {
    document.body.style.overflow = mobileOpen ? "hidden" : "auto";
    return () => { document.body.style.overflow = "auto" };
  }, [mobileOpen]);
// click otside sidebar - collapse
  useEffect(() => {
...
// a small component
 const renderMenuItem = ({ text, path, icon }) => {
  ...
  return (
    <>
        <motion.div className={sidebarStyles.sidebarContainer.base} ref={sidebarRef}
        ...
        >
            <div className={sidebarStyles.sidebarInner.base}>
                ...
                >
                    ...
                    to="https://github.com/NitishHegde"
                    >
                    ...
                    <button onClick={handleLogout} className={cn(
                        ...
                        <LogInIcon size={20} className="text-gray-500"/>
